...
def preprocessing_for_bert(data, max_len):
    ...
    for sent in data:
        ...
        input_ids.append(encoded_sent.get('input_ids')[:max_len])
        attention_masks.append(encoded_sent.get('attention_mask')[:max_len])
...
def main():
    ...
    for trial in range(NUM_TRIALS):
        ...
        with open(PATH + "BERT_CNN_scores_" + str(trial+3) + ".txt", 'w') as outfile:
